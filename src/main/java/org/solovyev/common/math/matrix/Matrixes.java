...
public class Matrixes {
    ...
    public static Matrix<Double> multiply(Matrix<Double> l, Matrix<Double> r) {
        ...
        try {
            ...
            Logger.getLogger(Matrixes.class).error(e);
    ...
    public static Double getEuclidianNorm(Matrix<Double> m) {
        Double sum = 0d;
        for (int i = 0; i < m.getNumberOfRows(); i++) {
            for (int j = 0; j < m.getNumberOfColumns(); j++) {
    ...
    public static Double getEuclidianDist(Matrix<Double> m1, Matrix<Double> m2) {
        return getEuclidianNorm(difference(m1, m2));
    }

    public static double maxInCol(Matrix<Double> m, int j) {
    ...
    public static double minInCol(Matrix<Double> m, int j) {
